...
- Совместно с «Феликс Ремонт» мы реализовали все три флагманских проекта,
  которые есть в их галерее: ЖК ONYX Deluxe, ЖК Рассказово (Новая Москва),
  улица Волгина. Дизайн — Екатерина, реализация — Феликс.
